...
const Signup = () => {
    ...
    const handleFileChange = (e, type) => {
        ...
        if (type === 'avatar') {
            ...
            // Append new valid documents to existing ones
            const updatedDocs = [...formData.docs, ...validDocs];
            ...
            setPreviewDocs([...previewDocs, ...newPreviews]);
        }
    };
            ...
            <div className="flex justify-between mb-6">
                {Array.from({ length: totalSteps }, (_, i) => (
                    <div key={i} className="flex-1 flex flex-col items-center">
                        <div
                            className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold ${step > i + 1
                        ...
                        <span className="text-xs mt-1 text-gray-600">
                            {selectedRole === 'Vendor'
                                ? ['Basic Info', 'Service', 'Portfolio', 'Media'][i]
                        ...
                        {selectedRole === 'Vendor' && step === 4 && (
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    {errors.doc_0 && <p className="text-red-500 text-xs mt-2">{errors.doc_0}</p>}
                                    {errors.doc_1 && <p className="text-red-500 text-xs mt-2">{errors.doc_1}</p>}
                                    {/* Add more as needed for additional documents */}
                                </div>
                            </div>
                        )}
