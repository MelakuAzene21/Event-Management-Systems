...
//         try {
//             await axios.delete(`${BASE_URL}/api/tickets/delete/${ticketToDelete}`, {
...
//                                 <p className="text-gray-600"><span className="font-bold">Date:</span> {new Date(ticket.event?.eventDate).toLocaleDateString()}</p>
                                
//                                 <p className="text-gray-600"><span className="font-bold">Seat:</span> {ticket.booking?.ticketType === "VIP" ? "VIP Access" : ticket.booking?.seat || "General Admission"}</p>
//                                 <p className="text-gray-600"><span className="font-bold">Price:</span> {ticket.booking?.totalAmount.toFixed(2)} ETB</p>
//                                 <p className="text-gray-600 mb-4"><span className="font-bold">Ticket Holder:</span> {ticket.user?.name || "N/A"}</p>
//                                 <QRCodeCanvas
//                                     value={ticket.qrCode}
//                                     size={150}
//                                     className="mb-4"
...
//                                 />
//                                 <p className="text-gray-600 mb-4 italic"><span className="font-bold">Ticket ID:</span> {ticket.ticketNumber}</p>
...
//                                             <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M12 16v-8m0 0l-4 4m4-4l4 4"></path>
//                                         </svg>
//                                         Download
//                                     </button>
//                                 </div>
...
//                                     <path strokeLinecap="round" strokeLinejoin="round" probableStrokeWidth="2" d="M6 18L18 6M6 6l12 12" />
//                                 </svg>
//                             </button>
//                         </div>
