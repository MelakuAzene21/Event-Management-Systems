...
// import { useGetReviewsQuery, useCreateReviewMutation, useUpdateReviewMutation, useDeleteReviewMutation } from "../features/api/reviewApi";
// import { useDispatch, useSelector } from "react-redux";
// import { setSelectedReview, clearSelectedReview } from "../features/slices/reviewSlice";
// import Rating from "react-rating-stars-component";

// const ReviewComponent = ({ eventId, attendeeId }) => {
...
//     // Handle Submit Review (Create/Update)
...
//             <h2 className="text-2xl font-semibold mb-4">{selectedReview ? "Edit Review" : "Add a Review"}</h2>
...
//                                 <p>{review.comment}</p>
//                             </div>
//                             {review.attendeeId?._id === attendeeId && ( // Only allow editing/deleting own review
...
const ReviewComponent = ({ eventId, attendeeId }) => {
    ...
    return (
        <div className="container mx-auto p-4  border-2 border-gray-200 rounded-lg mt-4">
            ...
            >
                <h2 className="text-xl font-semibold mb-4">{selectedReview ? "Edit Review" : "Post Your Review"}</h2>
                <form onSubmit={handleSubmit} className="mb-6 bg-white shadow-md p-4 rounded-lg">
                    <div className="mb-4">
                        <label className="block text-gray-700 font-semibold">Rating:</label>
                        <Rating value={rating} onChange={setRating} size={30} />
