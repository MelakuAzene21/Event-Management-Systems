...
const AllVendors = () => {
    ...
    const vendorsPerPage = 9; // Adjustable
                    ...
                    <Link to={`/vendors/${vendor._id}`} key={vendor._id} className="block group">
                        <div className="border border-gray-200 rounded-xl p-6 bg-white shadow-sm hover:shadow-md transition-shadow duration-200">
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <span
                                    className={`px-3 py-1 text-xs font-medium rounded-full ${vendor.status === 'active'
            ...
            {filteredVendors.length > vendorsPerPage && (
                <div className="mt-8 flex justify-center items-center gap-2">
                    <button
                        ...
                        className="p-2 rounded-full bg-gray-100 text-gray-600 hover:bg-indigo-100 hover:text-indigo-600 disabled:opacity-50 disabled:hover:bg-gray-100"
                    >
                        <ChevronLeft size={20} />
                    </button>
