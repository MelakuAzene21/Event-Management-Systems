                        ...
                        {booking && (
                            ...
                            >
                                ...
                                {/* <QRCodeCanvas id="qrCodeCanvas" value={booking.qrCode} size={180} className="shadow-lg border border-gray-300 p-2 rounded-lg" /> */}
                                    ...
                                    <div ref={qrRef}>
                                        {booking.qrCode ? (
                                            <QRCodeCanvas value={booking.qrCode} size={200} />
                                        ) : (
                                            <p>Loading QR Code...</p>
                                        )}
                                    </div>
...
//             if (!canvas) {
//                 console.error("Canvas not found! Make sure the QR Code renders correctly.");
//                 return;
//             }
...
//             if (qrCodeData) {
//                 console.log("✅ QR Code Data:", qrCodeData.data); // 🎯 Extracted QR Code Data
//             } else {
...
//                                 {/* ✅ Render QR code inside a div with ref */}
//                                 <div ref={qrRef}>
//                                     {booking.qrCode ? (
//                                         <QRCodeCanvas value={booking.qrCode} size={200} />
//                                     ) : (
...
//                                 <button
//                                     className="mt-4 px-5 py-2 bg-blue-500 text-white font-medium rounded-lg shadow-md hover:bg-blue-600 transition-all duration-300 transform hover:scale-105"
//                                     onClick={scanQRCode} // ✅ New function to scan QR Code
//                                 >
//                                     Scan QR Code
//                                 </button>
//                             </motion.div>
